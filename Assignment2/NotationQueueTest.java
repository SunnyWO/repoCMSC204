...
public class NotationQueueTest {
	...
	public Double aDouble=72.3, bDouble=22.1, cDouble=0.0, dDouble=23.3, eDouble=51.3, fDouble=2.4;
	...
	public void setUp() throws Exception {
		...
		doubleQ.enqueue(aDouble);
		doubleQ.enqueue(bDouble);
		doubleQ.enqueue(cDouble);
	}
	...
	public void testDequeueStudent() {
		...
		try {
			assertEquals(aDouble, doubleQ.dequeue());
			assertEquals(bDouble, doubleQ.dequeue());
			assertEquals(cDouble, doubleQ.dequeue());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleQ.dequeue();
			assertTrue("This should have caused an QueueUnderflowException", false);
		}
	...
	public void testEnqueueStudent() {
		...
		try {
			...
			assertEquals(true, doubleQ.enqueue(dDouble));
			assertEquals(4, doubleQ.size());
			assertEquals(true, doubleQ.enqueue(eDouble));
			assertEquals(5, doubleQ.size());
			//Queue is full, next statement should cause QueueOverFlowException
			doubleQ.enqueue(fDouble);
			assertTrue("This should have caused an QueueOverflowException", false);
		}
		catch (QueueOverflowException e){
			assertTrue("This should have caused an QueueOverflowException", true);
	...
	public void testToStringStudent() throws QueueOverflowException {
		//Use the doubleQ for student tests
		assertEquals("72.322.10.0", doubleQ.toString());
		doubleQ.enqueue(dDouble);
		assertEquals("72.322.10.023.3", doubleQ.toString());
		doubleQ.enqueue(eDouble);
		assertEquals("72.322.10.023.351.3", doubleQ.toString());
	}
